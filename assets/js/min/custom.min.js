...
/* Con javascript */ /* function eventShowTextDescription(){
		...
		} */ /* Con Jquery */function r(){a("#verMasDesplegable").click(function(){a("#desplegableContenido").hasClass("active")?(a("#desplegableContenido").hide("slow"),a("#desplegableContenido").removeClass("active")):(a("#desplegableContenido").show("slow"),a("#desplegableContenido").addClass("active"))})}// --- GLOBAL VARS ---------------------------- 
// COLOR SCROLLBAR
var s=window.innerWidth,t=[],u=".js-dms-custom-select",v=b("mousewheel")?"mousewheel":"wheel",w=// RETURN CORRECT TRANSITION EVENT NAME
function(){var a,b=document.createElement("fakeelement"),c={transition:"transitionend",OTransition:"oTransitionEnd",MozTransition:"transitionend",WebkitTransition:"webkitTransitionEnd"};for(a in c)if(b.style[a]!==void 0)return c[a]}(),x=// RETURN CORRECT ANIMATION EVENT NAME
...
n.prototype={initEvents:function(){var b=this;b.dd.on("click",function(){var b=a(this).hasClass("dms-active");return a(u).each(function(){a(this).hasClass("dms-active")&&a(this).removeClass("dms-active")}),b||a(this).toggleClass("dms-active"),!1}),b.opts.on("click",function(){var c=a(this);b.the_text=c.attr("data-label"),b.val=c.attr("data-value"),b.index=c.index(),b.placeholder.text(b.the_text)})},getValue:function(){return this.val},getIndex:function(){return this.index}};// END GLOBAL FUNCTIONS ---------------------------- 
// --- ON LOAD --------------------------------------
a(function(){r(),a(".dms-popup-for-bg-img").click(function(){e(a(this))}),c(u,o),c(".js-dms-search",f),c(".js-dms-to-top",h),c(".js-home-swiper-container",q);// CALL FUNCTION - FOR CUSTOM RGL POPUP
...
c(".js-dms-r-popup__open",g,b),c(".js-dms-ajax-more-posts__button",l),c(".js-dms-apss-social",m),c(".js-dmsMenuMobileToggle",d),0==a(".dms-parallax-scene #scene .layer").length?k():(p(),k()),j(),a(window).resize(function(){// RESET MENU MOBILE
// elements
